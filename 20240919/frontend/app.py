...
class NotesApp:
    ...
    def read_by_id(self,id):
        ...
        return res.json()
    def create(self,notes_json_str):
        headers={'Content-type':'application/json'}
        res=requests.post(f'{self.url}/notes/{id}',data=notes_json_str,headers=headers)
        return res.json()
    def update(self,id,notes_json_str):
        headers={'Content-type':'application/json'}
        res=requests.put(f'{self.url}/notes/{id}',data=notes_json_str,headers=headers)
        return res.json()
    def delete(self,id):
